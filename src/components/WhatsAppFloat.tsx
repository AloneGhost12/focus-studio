...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="whatsapp-buzz fixed bottom-6 right-5 z-50 rounded-full border border-white/40 bg-[#25D366] p-4 text-white shadow-2xl transition hover:scale-105 active:scale-100"
    >
